...
HD_PWD='C:/Users/alexn/OneDrive/Documents/Projects/HILTest/Rotom/Rotom.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2cAddrSwitch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2cAddrSwitch.tcl -notrace
