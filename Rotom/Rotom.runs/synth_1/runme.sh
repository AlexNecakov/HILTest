...
HD_PWD='C:/Users/alexn/OneDrive/Documents/Projects/HILTest/Rotom/Rotom.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2cAddrSwitch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2cAddrSwitch.tcl
